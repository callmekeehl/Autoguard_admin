        ...
        <table class="table table-bordered">
            ...
            @foreach($garages as $garage)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.garages.show', $garage['utilisateurId']) }}" class="btn btn-info btn-sm">Voir</a>
                        <a href="{{ route('admin.garages.edit', $garage['utilisateurId']) }}" class="btn btn-warning btn-sm">Modifier</a>
